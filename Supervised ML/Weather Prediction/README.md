...
This python script is a simple implementation of a <b>Logistic Regression model</b> to predict weather conditions (n = 4) based on temperature, humidity and wind speed.
